...
namespace IOAS.DataModel
{
    ...
    public partial class tblInstituteSalaryPaymentDeductionDetail
    {
        public int InstituteSalaryPaymentDeductionDetailId { get; set; }
        public Nullable<int> InstituteSalaryPaymentId { get; set; }
